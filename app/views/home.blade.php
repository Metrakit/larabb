  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <ul class="list-unstyled">
      	<li> @module('forum') <i class="fa fa-check"></i> @endmodule Forum </li>
      	<li> @module('user') <i class="fa fa-check"></i> @endmodule User </li>
      	<li> @module('shop') <i class="fa fa-check"></i> @endmodule Shop </li>
      	<li> @module('gallery') <i class="fa fa-check"></i> @endmodule Gallery </li>
      	<li> @module('search') <i class="fa fa-check"></i> @endmodule Search </li>
      </ul>
